...
export async function signupSpecialistAction(prevState: SignupState | null, formData: FormData): Promise<SignupState> {
  ...
  try {
    ...
    console.error("Specialist signup DB error:", error);
  ...
  try {
    ...
    console.error("Cookie set error during specialist signup:", error);
