...
CREATE TABLE IF NOT EXISTS experts (
  ...
  profile_status TEXT DEFAULT 'profile_incomplete' CHECK (profile_status IN ('profile_incomplete', 'pending_review', 'approved', 'rejected', 'suspended')),
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 13. Specialist & Appointment Additions (Migrated Modules)
-- ─────────────────────────────────────────────────────────────────────────────
